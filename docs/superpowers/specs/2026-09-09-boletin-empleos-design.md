...
- Filtrado por relevancia, nivel de experiencia, vigencia y legitimidad.
...
- **SPE** — ✅ **resuelto el 9 de septiembre de 2026.** API JSON pública, sin autenticación:
  ...
  **Es más rico de lo previsto y simplifica dos filtros del núcleo:**
  ...
  - `MESES_EXPERIENCIA_CARGO` vuelve el filtro de nivel de experiencia numérico en vez de heurístico.
...
| Nivel de experiencia (senior, lead, 5+ años) | **Sí**, en conteo agregado |
...
| **Volumen bajo de vacantes junior en Colombia** | Medio — boletines flacos | Medir en la primera ejecución real; ampliar el radio geográfico o relajar el filtro de nivel de experiencia |
...
│   ├── modelos.py
│   ├── nucleo/                      # sin E/S
│   │   ├── relevancia.py · experiencia.py · vigencia.py
